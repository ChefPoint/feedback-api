...
const validation_schema = {
  ...
  session: Joi.string()
    .max(30)
    .label("Feedback Collection Session"),
  ...
  // First Question
  firstQuestionTitle: Joi.string()
    .max(30)
    .label("First Question Title"),
  firstQuestionAnswer: Joi.object({
    icon: Joi.string()
      .max(50)
      .allow("")
      .label("First Question Answer - Icon"),
    label: Joi.string()
      .max(50)
      .allow("")
      .label("First Question Answer - Label"),
    value: Joi.number()
      .min(1)
      .max(15)
      .allow("")
      .label("First Question Answer - Value")
  }).label("First Question Answer"),

  // Second Question
  secondQuestionTitle: Joi.string()
    .max(30)
    .label("Second Question Title"),
  secondQuestionAnswer: Joi.object({
    icon: Joi.string()
      .max(50)
      .allow("")
      .label("Second Question Answer - Icon"),
    label: Joi.string()
      .max(50)
      .allow("")
      .label("Second Question Answer - Label"),
    value: Joi.string()
      .max(50)
      .allow("")
      .label("Second Question Answer - Value")
